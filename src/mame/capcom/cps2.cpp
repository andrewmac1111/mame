...
ROM_START( pzloop2jp )Add commentMore actions
	ROM_REGION( CODE_SIZE, "maincpu", 0 ) // 68000 code
...
GAME( 2001, pzloop2jp,  pzloop2, dead_cps2, pzloop2,   cps2_state, init_pzloop2, ROT0,   "Mitchell (Capcom license)", "Puzz Loop 2 (Japan 010201 Publicity)",           MACHINE_SUPPORTS_SAVE )Add commentMore actions
...
GAME( 1994, ssf2xjtb,   ssf2t,    dead_cps2comm, cps2_2p6b, cps2_state, init_cps2,     ROT0,   "bootleg", "Super Street Fighter II X: Tournament Battle (Japan 940223)",                                MACHINE_SUPPORTS_SAVE )
